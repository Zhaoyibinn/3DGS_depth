...
ply_data  = o3d.io.read_point_cloud("data/rgbd_dataset_freiburg1_desk/sparse/0/oni.xyz")
o3d.io.write_point_cloud("data/rgbd_dataset_freiburg1_desk/sparse/0/zhongjian.xyz", ply_data)

datadir = os.environ.get('DATADIR', '../data')
datafile = 'data/rgbd_dataset_freiburg1_desk/sparse/0/zhongjian.xyz'
...
points.write('data/rgbd_dataset_freiburg1_desk/sparse/0/output.ply')